...
public class ProductOrderAdapter extends ArrayAdapter<ProductOrder> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            productOrderHolder.dlvryId = convertView.findViewById(R.id.dlvryId);
            ...
            convertView.setTag(R.id.dlvryId, productOrderHolder.dlvryId);
        ...
        productOrderHolder.dlvryId.setText(list.get(position).getDlvryId());
    ...
    static class ProductOrderHolder{
        ...
        protected static TextView dlvryId;
